...
### [nestjs-postgress-nuxt](./nestjs-postgress-nuxt)
```bash
cd ./nestjs-postgress-nuxt && yarn dev
```
...
### [nestjs-mongodb-nuxt3](./nestjs-mongodb-nuxt3)
```bash
cd ./nestjs-mongodb-nuxt3 && yarn dev
```
...
### [nestjs-mysql](./nestjs-mysql)
```bash
cd ./nestjs-mysql && yarn dev
```
