...
Execute `npm run dev` para levantar o serviço e se conectar ao serviço levantado.

Para iniciar um projeto, execute `npx hyperframes init my-video` e acesse http://localhost:3000 para ver o preview em tempo real.
